...
import time
import base64
# Optional drawing canvas (streamlit-drawable-canvas)
try:
                    ...
                    if st.button("Create Packshot"):
                        with st.spinner("Creating professional packshot..."):
                            try:
                                ...
                                # Create packshot; the packshot endpoint can force background removal if requested.
        ...
        if uploaded_file:
            ...
            with col1:
                ...
                if st_canvas is None:
                    st.warning("⚠️ The drawing canvas is unavailable. Install `streamlit-drawable-canvas` with: `pip install streamlit-drawable-canvas`")
                    canvas_result = None
                else:
                ...
                if st.button("🎨 Generate", type="primary"):
                    if st_canvas is None:
                        st.error("❌ Drawing canvas not available. Install `streamlit-drawable-canvas` and restart the app.")
                        return
